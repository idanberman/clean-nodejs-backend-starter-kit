...
import { UseCaseInputErrorDescription } from 'src/domain/kernel/errors/operation/by-user/values/UseCaseInputErrorDescription';
export class ClassValidationErrorToDomainResultConverter {
  public convert(
    ...
    return IoFormattingResult.createFailed(
